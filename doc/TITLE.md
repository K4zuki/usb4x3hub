...
## エンクロージャ（ケース）
エンクロージャ（ケース）は、頒布しません。代わりにアイデアを2点だけ提示します。
...
### 全部自作する
アクリルレーザ加工で6面全てとそれらのジョイントと言うかブロックスペーサ
を入手して組み合わせるという手も考えられます。以下はアイデアだけなので
参考程度にして
ください^[https://gist.github.com/K4zuki/fb18026aae4fe79f22a7cca4114dfed6]。
